...
| 文档 | 说明 |
|------|------|
| [项目计划](./项目计划.md) | 整体计划、需求、时间线 |
| [课程要求对照](./docs/requirements/课程要求对照.md) | 官方要求逐条对照 |
| [设计文档目录](./docs/design/README.md) | 设计类文档索引 |
| [团队分工表](./docs/report/团队分工表.md) | 写入课程报告的分工章节 |
| [报告目录](./docs/report/README.md) | 课程设计报告结构与检查清单 |
| [测试文档目录](./docs/test/README.md) | 测试用例与报告 |
| [用户手册目录](./docs/user-manual/README.md) | 操作说明与演示脚本 |

### PPT 组

| 文档 | 说明 |
|------|------|
| [项目计划 · 答辩准备](./项目计划.md#六答辩准备) | 演示脚本、常见 Q&A |
| [PPT 目录说明](./ppt/README.md) | 幻灯片结构、素材存放 |
